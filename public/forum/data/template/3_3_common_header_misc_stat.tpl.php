...
0
|| checktplrefresh('./template/gstudio_qxl/common/header.htm', './template/default/common/header_common.htm', 1507800143, '3', './data/template/3_3_common_header_misc_stat.tpl.php', './template/gstudio_qxl', 'common/header_misc_stat')
|| checktplrefresh('./template/gstudio_qxl/common/header.htm', './template/gstudio_qxl/common/pubsearchform.htm', 1507800143, '3', './data/template/3_3_common_header_misc_stat.tpl.php', './template/gstudio_qxl', 'common/header_misc_stat')
|| checktplrefresh('./template/gstudio_qxl/common/header.htm', './template/default/common/header_qmenu.htm', 1507800143, '3', './data/template/3_3_common_header_misc_stat.tpl.php', './template/gstudio_qxl', 'common/header_misc_stat')
;?>
