...
0
|| checktplrefresh('./template/gstudio_qxl/common/header.htm', './template/default/common/header_common.htm', 1508982101, '3', './data/template/3_3_common_header_member_register.tpl.php', './template/gstudio_qxl', 'common/header_member_register')
|| checktplrefresh('./template/gstudio_qxl/common/header.htm', './template/gstudio_qxl/common/pubsearchform.htm', 1508982101, '3', './data/template/3_3_common_header_member_register.tpl.php', './template/gstudio_qxl', 'common/header_member_register')
|| checktplrefresh('./template/gstudio_qxl/common/header.htm', './template/default/common/header_qmenu.htm', 1508982101, '3', './data/template/3_3_common_header_member_register.tpl.php', './template/gstudio_qxl', 'common/header_member_register')
;?>
...
<div class="hdc cl wp"><?php $mnid = getcurrentnav();?><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2><?php include template('common/header_userstatus'); ?></div>
