...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1508917750, '3', './data/template/3_3_member_login.tpl.php', './template/gstudio_qxl', 'member/login')
...
<!--<td class="tipcol"><a href="http://newjy.net/index/register/index.html"><?php echo $_G['setting']['reglinkname'];?></a></td>-->
</tr>
</table>
</div>
<div class="rfm">
