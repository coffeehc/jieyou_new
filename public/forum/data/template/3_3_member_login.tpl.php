...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1508320534, '3', './data/template/3_3_member_login.tpl.php', './template/gstudio_qxl', 'member/login')
