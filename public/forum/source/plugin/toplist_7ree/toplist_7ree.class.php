...
$searchnums = 18;//搜索总数.
$cachelife = $vars_7ree[cachetime_7ree] * 60;//缓存时间.
...
//////////////////其他数据调用
        //---设置---start
        $cachename_toplist	= "toplist_7ree";//缓存名.若与何插件冲突请修改,只要不冲突不会影响使用.
